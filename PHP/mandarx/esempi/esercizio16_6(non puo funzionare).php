...
<html>
<head>
    <title>Exercise: Dynamic Personalization with css (not working)</title>
    <?php
...
<?php
    ...
    echo "<body>";
    echo "<h2>Questa soluzione non può funzionare perché il PHP non viene eseguito nei file .css</h2>";
